...
export const BlogPost = () => (
  <div className="row row-center">
    <div className="small-12 medium-9 columns tip-blog-post">
      <div className="tip-blog-heading">
        <h1 className="tip-blog-heading-text">
          Introducing the Irrelevant Project.
        </h1>

        <h3 className="tip-blog-subheading">
          Anurag Choudhary |<BbAnimatedText strings={[" 03/29/17", " MARCH 29 2017"]} />
        </h3>
      </div>
