      ...
      <DocumentTitle title="Home - The Irrelevant Project">
        <div className="tip-home" >
          ...
          <div className="section hero-text-container bg-image-container">
            {/* <img src="https://scontent.fsea1-1.fna.fbcdn.net/v/t31.0-8/26171406_10214072079813231_2876741868605192743_o.jpg?oh=dbb0f2eb86638b00b6e13a05bbecff1a&oe=5AF6FB4C" /> */}
...
export class HomeBox extends React.Component<IHomeBoxProps, IHomeBoxState> {
  ...
  public render() {
    ...
    const arrow = <div className="nav-arrow"><RightArrow /></div>;
    return (
      <TipLink to={this.props.linkTo} external={this.props.linkExternal} classes="home-box-link">
        <div className={classes} onMouseOver={this.onMouseOver} onMouseOut={this.onMouseOut}>
          ...
          <span className={`title ${this.props.hideTitleWhenNotHover ? "hide-when-not-hover" : ""}`}>
            {this.props.title}
          </span>
